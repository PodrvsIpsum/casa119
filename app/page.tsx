...
function FoodMenu() { return <div className="menu-sections"><div><h3>♧ Saladas</h3><span>Salada de Cogumelos <b>R$42</b></span><span>Salada Tropical <b>R$28</b></span><span>Salada Tropical com Frango <b>R$30</b></span><span>Salada de Cabra <b>R$32</b></span></div><div><h3>◉ Sandubas <small>das 18h às 23h</small></h3><span>Caprese Capril <b>R$18</b></span><span>Invocado <b>R$15</b></span><span>Código Verde <b>R$20</b></span><span>Brasa 119 <b>R$22</b></span></div><div><h3>✦ Bolinhos</h3><span>Cabra &amp; Caponata <b>R$15</b></span><span>Cogumelo &amp; Queijo <b>R$11</b></span><span>Cupim &amp; Ovo Perfeito <b>R$15</b></span><span>Cupim &amp; Queijo <b>R$18</b></span></div><div><h3>✺ Porções · Molhos</h3><span>Chips da Casa <b>R$34</b></span><span>Couve-flor Apimentada <b>R$39</b></span><span>Frango Crocante <b>R$44</b></span><span>Gergelim Cítrico <b>R$4</b></span><span>Verde Queimado <b>R$3</b></span><span>Holandês <b>R$10</b></span><span>Pesto Genovês <b>R$6</b></span></div></div>; }
function DrinkItem({ name, price, notes }: { name: string; price: string; notes?: string }) { return <div className="drink-item"><div><span>{name}</span>{notes && <small>{notes}</small>}</div><b>{price}</b></div>; }
function BarMenu() { return <div className="menu-sections bar-menu"><div><h3>✦ O bar autoral</h3><DrinkItem name="Banzeiro" price="R$28" notes="Cítrico · doce · herbal" /><DrinkItem name="Paloma 119" price="R$32" notes="Cítrico · levemente amargo · doce" /><DrinkItem name="Raiz 119" price="R$22" notes="Cítrico · herbal · refrescante" /><DrinkItem name="Goiaba em Chamas" price="R$25" notes="Doce · herbal · intenso" /><DrinkItem name="Spritz 119" price="R$30" notes="Cítrico · amargo · refrescante" /><DrinkItem name="Spritz 119 — Bananinha" price="R$26" notes="Cítrico · amargo · refrescante" /><DrinkItem name="Oxe Oxe" price="R$27" notes="Vibrante · cítrico" /><DrinkItem name="Aperol Mule" price="R$28" notes="Cítrico · amargo · refrescante" /><DrinkItem name="Benegrip 119" price="R$26" notes="Cítrico · levemente amargo · doce" /></div><div><h3>◌ Tradicionais</h3><DrinkItem name="Negroni" price="R$32" notes="Amargo · herbal · cítrico" /><DrinkItem name="Bloody Mary" price="R$38" notes="Salgado · picante · umami" /><DrinkItem name="Drink Unicórnio" price="R$33" notes="Cítrico · leve · refrescante" /><DrinkItem name="Caipirinha Vodka Hype" price="R$20" /><DrinkItem name="Caipiroska Sagatiba" price="R$18" /></div><div><h3>☼ Sem álcool</h3><DrinkItem name="Código Amarelo 119" price="R$18" notes="Cítrico · doce · refrescante" /><DrinkItem name="Código Morse 119" price="R$20" notes="Doce · frutado · refrescante" /><DrinkItem name="Mary Sem Jane" price="R$22" notes="Temperado · salgado · leve" /></div></div>; }function ProgramMenu() { return <div className="menu-sections"><div><h3>✦ Programação fixa</h3><span><b>SEG</b>TV na Real</span><small>Com participações ao vivo · espaço livre para seu momento</small><span><b>TER</b>Casa Fechada</span><small>Dia reservado para manutenção e organização interna</small><span><b>QUA</b>Oficinas Culturais</span><small>Dia dedicado para você expressar sua criatividade</small><span><b>QUI</b>Palco Acústico</span><small>Noite dedicada à programação instrumental</small><span><b>SEX</b>Noite Urbana</span><small>Noite com reggae, pop e rap</small><span><b>SÁB</b>Baile Principal</span><small>O grande encontro do fim de semana: teremos rap, pop e funk</small><span><b>DOM</b>TV na Real</span><small>Brasilidade &amp; cultura · discotecagem e eventos</small></div></div>; }

export default function Home() {
  const [menuOpen, setMenuOpen] = useState(false);
  const [panel, setPanel] = useState<"food" | "brunch" | "bar" | "program" | null>(null);
    ...
    <main id="conteudo">
      <section id="top" className="hero" aria-labelledby="hero-title">
        <div className="hero-panel" onPointerMove={(event) => { const rect = event.currentTarget.getBoundingClientRect(); event.currentTarget.style.setProperty("--glow-x", `${event.clientX - rect.left}px`); event.currentTarget.style.setProperty("--glow-y", `${event.clientY - rect.top}px`); }} onPointerLeave={(event) => { event.currentTarget.style.removeProperty("--glow-x"); event.currentTarget.style.removeProperty("--glow-y"); }}>
          ...
          <Mark />
          <div className="hero-message"><p className="eyebrow">Cultura · comida · música</p><h1 id="hero-title">Chega mais.<br /><i>A casa é sua.</i></h1><p className="hero-copy">Um endereço vivo para comer bem, brindar sem pressa e encontrar o que você nem sabia que estava procurando.</p><div className="hero-actions"><a href="https://instagram.com/119acasa" target="_blank" rel="noopener noreferrer">Conheça a Casa</a><a href="https://instagram.com/119acasa" target="_blank" rel="noopener noreferrer">O que está rolando <Arrow /></a></div></div>
          <p className="hero-footnote">Av. Dr. Olavo Guimarães, 119<br />Vila Arens — Jundiaí/SP</p><p className="hero-hours"><b>Qua–seg · 15h–22h</b><span>terça fechada</span></p>
        </div>
