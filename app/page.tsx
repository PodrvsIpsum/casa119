...
export default function Home() {
  ...
  return <>
    ...
    <main id="conteudo">
      ...
      <section className="intro-band" aria-label="Manifesto"><p className="eyebrow">A Casa por dentro</p><h2>Você não vem só para consumir.<br /><i>Você vem para fazer parte.</i></h2><p className="intro-detail">A Casa 119 mistura gastronomia, arte, música e gente em um espaço que muda conforme o dia. Ã‰ bar, pátio, palco, mesa e ponto de encontro.</p></section>

      <section className="room-index" aria-label="Explore a Casa">
        <div className="section-head"><p className="eyebrow">Escolha seu cômodo</p><p className="section-count">01 â€” 03</p></div>
